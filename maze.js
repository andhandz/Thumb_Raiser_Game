...
export default class Maze {
    ...
    /* Measure the player’s distance to the walls
    ...
    foundExit(position) {
        ...
        return Math.abs(position.x-this.exitLocation.x) < this.scale.x*0.5 && Math.abs(position.z-this.exitLocation.z) < this.scale.z*0.5; 
    };
}